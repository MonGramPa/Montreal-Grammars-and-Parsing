---
layout: chapter
title: Notes on Harkema (2001:§3.2)
...
1. Given an MCFG $$G$$, construct a MG $$G'$$ (§3.3)
2. Show that $$L(G) = L(G')$$. Harkema does this by:
    ...
    2. Proving 8 properties of MGs (§3.6.1: thms 1-8)
    3. Using these properties to prove these two propositions: (§3.6.2)
